...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45030 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45030(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45031 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45031(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45032 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45032(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45036 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45036(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45037 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45037(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45038 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45038(reader);
}
});
...
var G__45054 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45055 = s.append(c);
c = G__45054;
s = G__45055;
continue;
}
