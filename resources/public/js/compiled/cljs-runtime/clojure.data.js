...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__41649){
...
var vec__41655 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41655,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41655,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41655,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_41703 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_41703(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_41704 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_41704(a,b);
}
});
...
var fexpr__41690 = (function (){var G__41691 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41691__$1)].join('')));

}
})();
return (fexpr__41690.cljs$core$IFn$_invoke$arity$2 ? fexpr__41690.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__41690.call(null,a,b));
}));
/**
