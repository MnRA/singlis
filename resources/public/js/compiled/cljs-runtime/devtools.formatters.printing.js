...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq44119){
var G__44120 = cljs.core.first(seq44119);
var seq44119__$1 = cljs.core.next(seq44119);
var G__44121 = cljs.core.first(seq44119__$1);
var seq44119__$2 = cljs.core.next(seq44119__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44120,G__44121,seq44119__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__44148_SHARP_){
return (!((cljs.core.meta(p1__44148_SHARP_) == null)));
})))){
...
var map__44234 = opts;
var map__44234__$1 = (((((!((map__44234 == null))))?(((((map__44234.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44234.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44234):map__44234);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44234__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e44270){var _e__41529__auto__ = e44270;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e44276){var _e__41529__auto__ = e44276;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__44286 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__44287 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__44287);

try{var map__44289 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44289__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__44286);
}});
...
var temp__5733__auto___44397 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___44397)){
var managed_print_level_44398 = temp__5733__auto___44397;
var _STAR_print_level_STAR__orig_val__44309_44399 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__44310_44400 = managed_print_level_44398;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__44310_44400);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__44304_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__44304_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__44309_44399);
}} else {
job_fn();
}
