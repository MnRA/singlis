...
}catch (e41595){var _e = e41595;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___41641 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___41641)){
var seen_errors_41642 = temp__5733__auto___41641;
if(cljs.core.truth_(seen_errors_41642.has(self))){
} else {
seen_errors_41642.add(self);

var temp__5735__auto___41643 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___41643)){
var sense_41644 = temp__5735__auto___41643;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41644)].join(''));
} else {
}
}
} else {
