...
var o43560 = temp__5733__auto__;
var temp__5733__auto____$1 = (o43560["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o43561 = temp__5733__auto____$1;
return (o43561["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41513__auto__ = f;
return (o__41513__auto__["toString"]).call(o__41513__auto__);
} else {
return "";
}
}catch (e43562){var _ = e43562;
return "";
}});
...
try{var o__41513__auto___43791 = t;
(o__41513__auto___43791["cljs$lang$ctorPrWriter"]).call(o__41513__auto___43791,t,writer);
}catch (e43566){var __43792 = e43566;
}
...
var char_code = (function (){var o__41513__auto__ = (new String(char$));
return (o__41513__auto__["charCodeAt"]).call(o__41513__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41513__auto__ = String;
return (o__41513__auto__["fromCharCode"]).call(o__41513__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43573 = num_code;
switch (G__43573) {
case (1):
return (185);
...
var o__41513__auto__ = String;
return (o__41513__auto__["fromCharCode"]).call(o__41513__auto__,superscript_code);
});
/**
...
}catch (e43581){var _e__41529__auto__ = e43581;
return false;
}})())){
...
var vec__43582 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43582,(0),null);
...
var len__4736__auto___43828 = arguments.length;
var i__4737__auto___43829 = (0);
while(true){
if((i__4737__auto___43829 < len__4736__auto___43828)){
args__4742__auto__.push((arguments[i__4737__auto___43829]));

var G__43830 = (i__4737__auto___43829 + (1));
i__4737__auto___43829 = G__43830;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43608){
var vec__43609 = p__43608;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43609,(0),null);
...
var G__43831 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__43832 = cljs.core.butlast(remaining_tokens);
name_tokens = G__43831;
remaining_tokens = G__43832;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43606){
var G__43607 = cljs.core.first(seq43606);
var seq43606__$1 = cljs.core.next(seq43606);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43607,seq43606__$1);
}));
...
var vec__43629 = cljs.core.split_with((function (p1__43628_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43628_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43629,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43629,(1),null);
...
var vec__43638 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43638,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43638,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__43835 = cljs.core.rest(remaining_tokens);
var G__43836 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__43835;
name_tokens = G__43836;
continue;
} else {
...
var vec__43643 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43643,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43643,(1),null);
var vec__43646 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43646,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43646,(1),null);
var vec__43649 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43649,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43649,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43649,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43649,(3),null);
...
var vec__43655 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43655,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43655,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43655,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43655,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43655,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43655,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__43660 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43660,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43660,(1),null);
var vec__43663 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43663,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43663,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__43688 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__43688) : devtools.munging.parse_fn_info_deep.call(null,G__43688));
})()));
}
} else {
return fn_info;
...
var G__43851 = (arity + (1));
var G__43852 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43701){
var vec__43702 = p__43701;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43702,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43702,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43708_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__43708_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43710_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__43710_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___43854 = arguments.length;
var i__4737__auto___43855 = (0);
while(true){
if((i__4737__auto___43855 < len__4736__auto___43854)){
args__4742__auto__.push((arguments[i__4737__auto___43855]));

var G__43856 = (i__4737__auto___43855 + (1));
i__4737__auto___43855 = G__43856;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43716){
var vec__43717 = p__43716;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43717,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43714){
var G__43715 = cljs.core.first(seq43714);
var seq43714__$1 = cljs.core.next(seq43714);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43715,seq43714__$1);
}));
...
var G__43724 = arg;
var G__43724__$1 = (((G__43724 instanceof cljs.core.Keyword))?G__43724.fqn:null);
switch (G__43724__$1) {
...
var map__43748 = options;
var map__43748__$1 = (((((!((map__43748 == null))))?(((((map__43748.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43748.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__43748):map__43748);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43748__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43748__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43748__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43748__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43749 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43749,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43749,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43749,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43749,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43749,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43749,(5),null);
...
var o__41513__auto__ = f;
return (o__41513__auto__["getBasis"]).call(o__41513__auto__);
});
/**
...
}catch (e43762){var _e__41529__auto__ = e43762;
...
var G__43905 = (obj[cljs.core.first(path)]);
var G__43906 = cljs.core.rest(path);
obj = G__43905;
path = G__43906;
continue;
} else {
...
var _STAR_ = (function (accum,p__43769){
var vec__43770 = p__43769;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43770,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43770,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43773){
var vec__43774 = p__43773;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43774,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43774,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43774,(2),null);
...
var post_process = (function (p__43778){
var vec__43779 = p__43778;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43779,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43779,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43777_SHARP_){
return (obj[cljs.core.first(p1__43777_SHARP_)]);
}),sorted_matches);
