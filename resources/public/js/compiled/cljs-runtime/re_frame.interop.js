...
return [(function (){var pred__52102 = cljs.core.instance_QMARK_;
var expr__52103 = reactive_val;
if(cljs.core.truth_((pred__52102.cljs$core$IFn$_invoke$arity$2 ? pred__52102.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52103) : pred__52102.call(null,reagent.ratom.RAtom,expr__52103)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52102.cljs$core$IFn$_invoke$arity$2 ? pred__52102.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52103) : pred__52102.call(null,reagent.ratom.RCursor,expr__52103)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52102.cljs$core$IFn$_invoke$arity$2 ? pred__52102.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52103) : pred__52102.call(null,reagent.ratom.Reaction,expr__52103)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52102.cljs$core$IFn$_invoke$arity$2 ? pred__52102.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52103) : pred__52102.call(null,reagent.ratom.Track,expr__52103)))){
return "tr";
} else {
return "other";
}
