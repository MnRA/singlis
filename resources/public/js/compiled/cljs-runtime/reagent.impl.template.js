...
var G__51951 = o;
goog.object.set(G__51951,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__51984__i = 0, G__51984__a = new Array(arguments.length -  0);
while (G__51984__i < G__51984__a.length) {G__51984__a[G__51984__i] = arguments[G__51984__i + 0]; ++G__51984__i;}
  args = new cljs.core.IndexedSeq(G__51984__a,0,null);
} 
return G__51983__delegate.call(this,args);};
G__51983.cljs$lang$maxFixedArity = 0;
G__51983.cljs$lang$applyTo = (function (arglist__51985){
var args = cljs.core.seq(arglist__51985);
...
var G__51953 = o;
goog.object.set(G__51953,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51988__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51988 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__51988__delegate.call(this,args);};
G__51988.cljs$lang$maxFixedArity = 0;
G__51988.cljs$lang$applyTo = (function (arglist__51990){
var args = cljs.core.seq(arglist__51990);
return G__51988__delegate(args);
});
G__51988.cljs$core$IFn$_invoke$arity$variadic = G__51988__delegate;
return G__51988;
})()
;
} else {
...
var G__51954 = props;
var G__51954__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51954,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51954);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51954__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__51954__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51956 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51956,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51956;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51959){
var map__51960 = p__51959;
var map__51960__$1 = (((((!((map__51960 == null))))?(((((map__51960.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51960.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__51960):map__51960);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51960__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__51962_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51962_SHARP_);
}));
} else {
return null;
}
...
var vec__51964 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51964,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51964,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51964,(2),null);
...
var temp__5739__auto___52002 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___52002 == null)){
} else {
var key_52007 = temp__5739__auto___52002;
(jsprops.key = key_52007);
}
...
var temp__5739__auto___52020 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___52020 == null)){
} else {
var key_52021 = temp__5739__auto___52020;
(jsprops.key = key_52021);
}
...
var G__51968 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51968) : reagent.impl.template.as_element.call(null,G__51968));
} else {
var temp__5739__auto___52022 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___52022 == null)){
} else {
var key_52023 = temp__5739__auto___52022;
(jsprops.key = key_52023);
}
...
var G__51970 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__51970)){
return x;
} else {
...
var len__4736__auto___52024 = arguments.length;
var i__4737__auto___52025 = (0);
while(true){
if((i__4737__auto___52025 < len__4736__auto___52024)){
args__4742__auto__.push((arguments[i__4737__auto___52025]));

var G__52026 = (i__4737__auto___52025 + (1));
i__4737__auto___52025 = G__52026;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51971){
var G__51972 = cljs.core.first(seq51971);
var seq51971__$1 = cljs.core.next(seq51971);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51972,seq51971__$1);
}));
...
break;
default:
var G__52028 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__52028;
continue;
...
var ctx = ({});
var vec__51975 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51975,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51975,(1),null);
...
var G__51978 = (cljs.core.count(argv) - first_child);
switch (G__51978) {
case (0):
