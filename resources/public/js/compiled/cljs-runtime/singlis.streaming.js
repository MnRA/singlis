...
return token.approve(singlis.streaming.sablier_address,deposit).then((function (p1__49521_SHARP_){
return p1__49521_SHARP_.wait();
}));
});
singlis.streaming.create_stream = (function singlis$streaming$create_stream(sablier,start_time,stop_time,recipient,deposit){
return sablier.createStream(recipient,deposit,singlis.streaming.testnetDAI_address,start_time,stop_time).then((function (p1__49522_SHARP_){
return p1__49522_SHARP_.wait();
}));
});
singlis.streaming.now = (function singlis$streaming$now(){
return Math.round(((new Date()).getTime() / (1000)));
});
singlis.streaming.process_form = (function singlis$streaming$process_form(p__49523){
var map__49524 = p__49523;
var map__49524__$1 = (((((!((map__49524 == null))))?(((((map__49524.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49524.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49524):map__49524);
var hours = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49524__$1,new cljs.core.Keyword(null,"hours","hours",58380855));
var quantity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49524__$1,new cljs.core.Keyword(null,"quantity","quantity",-1929050694));
var recipient = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49524__$1,new cljs.core.Keyword(null,"recipient","recipient",1650072234));
